	...
	public boolean insert(CareHistory careHistory) {
	    ...
	    try ( Connection connection = DataSource.getDataSource();
	        PreparedStatement pStatement = 
        		connection.prepareStatement("INSERT INTO CARE_HISTORY ( IDX, CARE_DATE, CARE_ID, TRAINEE_ID ) VALUES (?, ?, ?, ?)") ) {
	
	    	pStatement.setInt(1, careHistory.getIdx());
	        pStatement.setDate(2, careHistory.getCareDate());
	        pStatement.setInt(3, careHistory.getCare().getId()); 
	        pStatement.setInt(4, careHistory.getTrainee().getId());  
